function loc = pixelLocalSubMaxima(metric, loc, halfPatchSize)
%pixelLocalSubMaxima Determine location of maxima with subpixel precision
% Function is taken from a sub function of detectCheckerboardPoints
